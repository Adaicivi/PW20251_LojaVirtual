...
def read_categorias(request: Request):
    ...
    response = templates.TemplateResponse("categoria.html", {"request": request, "categorias": categorias})
    return response

@app.get("/endereco")
def read_enderecos(request: Request):
    enderecos = obter_enderecos_por_pagina(12, 0)
    response = templates.TemplateResponse("endereco.html", {"request": request, "enderecos": enderecos})
    return response
